--------------------------------------------------------------------------------
--
-- Travelpoints Textures 128 1.0                                      2015-03-24
--
-- By Racso Rhodes
--
-- travelpoints-textures-128/readme.txt
--
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
	...
	About
		...
		128x128 textures for the Minetest mod "Travelpoints".
	...
	Install
		...
		For example, if you are using "HDX 128", you would move these files to
		the textures/HDX_128px directory in your Minetest installation directory.
